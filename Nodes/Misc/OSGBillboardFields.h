...
typedef FCPtr<NodeCorePtr, Billboard> BillboardPtr;
...
#pragma do_not_instantiate SField<BillboardPtr>::_fieldType
...
#pragma do_not_instantiate MField<BillboardPtr>::_fieldType
