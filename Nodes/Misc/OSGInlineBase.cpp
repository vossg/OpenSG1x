...
namespace
{
    ...
    static char cvsid_hpp       [] = OSGINLINEBASE_HEADER_CVSID;
    static char cvsid_inl       [] = OSGINLINEBASE_INLINE_CVSID;

    static char cvsid_fields_hpp[] = OSGINLINEFIELDS_HEADER_CVSID;
}
