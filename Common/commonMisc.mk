...
INCL_DIR                  := $(OSGPOOL)/Nodes/Misc

PROJLIBS_FILE             := \
	$(OSGPOOL)/Nodes/Misc/libMisc.$(OS).$(LIBEXT)
...
PROJLIBS_MISC := "$(shell cygpath -w $(PROJLIBS_FILE))"
else
...
PROJLIBS_MISC := $(PROJLIBS_FILE)
endif

PROJLIBS$(OS)  += $(PROJLIBS_MISC)
