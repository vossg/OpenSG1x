...
INCL_DIR                  := $(OSGPOOL)/Loader

PROJLIBS_FILE             := \
	$(OSGPOOL)/Loader/libLoader.$(OS).$(LIBEXT)
...
PROJLIBS_LOADER := "$(shell cygpath -w $(PROJLIBS_FILE))"
else
...
PROJLIBS_LOADER := $(PROJLIBS_FILE)
endif

PROJLIBS$(OS)  += $(PROJLIBS_LOADER)
