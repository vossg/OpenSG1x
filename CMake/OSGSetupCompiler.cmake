...
#    STRING(REPLACE "W3"  "W1" OSG_C_FLAGS         ${OSG_C_FLAGS})
    ...
    SET(OSG_SHARED_LINKER_FLAGS "${OSG_SHARED_LINKER_FLAGS} /nodefaultlib /FORCE:MULTIPLE") 
...
IF(CMAKE_COMPILER_IS_GNUCC)
    ...
    IF(OSG_PLATFORM_64 AND LINUX)
        ...
        SET(OSG_SHARED_LINKER_FLAGS "${OSG_SHARED_LINKER_FLAGS} -m64 -Wl,--no-undefined")
