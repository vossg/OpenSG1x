...
#ifndef _OSGATTACHMENTMIXIN_HPP_
#define _OSGATTACHMENTMIXIN_HPP_
#ifdef __sgi
#pragma once
#endif
...
class AttachmentMixin : public AttachmentDescT::Parent
{
  private:
  ...
  public:
    ...
    OSG_RC_FIRST_ELEM_IDM_DECL(ParentsField);

    OSG_RC_LAST_ELEM_IDM_DECL (ParentsField);
  ...
  public :
    ...
    void addParent(ParentPtr pParent);
    void subParent(ParentPtr pParent);

    /*-------------------------- field access -------------------------------*/

    MFParentPtr *getMFParents(void);
};
...
#endif /* _OSGATTACHMENTMIXIN_HPP_ */
