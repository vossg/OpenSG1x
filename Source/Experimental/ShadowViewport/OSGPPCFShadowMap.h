...
#ifndef _OSGPPCFSHADOWMAP_H_
#define _OSGPPCFSHADOWMAP_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_SYSTEMLIB_DLLMAPPING PPCFShadowMap : public TreeRenderer
{
  private:
  ...
  public:
	  ...
	  PPCFShadowMap(void);
      PPCFShadowMap(ShadowViewport *source);
	  ~PPCFShadowMap(void);
