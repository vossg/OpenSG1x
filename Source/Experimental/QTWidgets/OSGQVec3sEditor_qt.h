...
#ifndef _OSGQVEC3SEDITOR_QT_H_
#define _OSGQVEC3SEDITOR_QT_H_
#ifdef __sgi
#pragma once
#endif
    ...
    public QVectorPointEditor<Vec3s>
{
  ...
  public:
    ...
    QVec3sEditor(QWidget *pParent, const char *name);

    virtual ~QVec3sEditor(void);
...
#define OSGQVEC3SEDITORQT_HEADER_CVSID "@(#)$Id: OSGQVec3sEditor_qt.h,v 1.1 2004/07/30 15:32:15 neumannc Exp $"
