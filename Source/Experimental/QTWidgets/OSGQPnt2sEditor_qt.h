...
class OSG_WINDOWQTLIB_DLLMAPPING QPnt2sEditor :
    public QVectorPointEditor<Pnt2s>
{
    Q_OBJECT
  ...
  private:
    typedef QVectorPointEditor<Pnt2s> Inherited;
...
#define OSGQPNT2SEDITORQT_HEADER_CVSID "@(#)$Id: OSGQPnt2sEditor_qt.h,v 1.1 2004/07/30 15:31:58 neumannc Exp $"
