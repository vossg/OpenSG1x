...
#ifndef _OSGQINT16EDITOR_QT_H_
#define _OSGQINT16EDITOR_QT_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_WINDOWQTLIB_DLLMAPPING QInt16Editor :
    public QAbstractValueEditor
{
  ...
  public:
    ...
    QInt16Editor(QWidget *pParent, const char *name);

    virtual ~QInt16Editor(void);
  ...
  private:
    ...
    QScalarEditorHelper<Int16> _editHelper;
};
...
#define OSGQINT16EDITORQT_HEADER_CVSID "@(#)$Id: OSGQInt16Editor_qt.h,v 1.3 2004/11/01 12:24:29 neumannc Exp $"
