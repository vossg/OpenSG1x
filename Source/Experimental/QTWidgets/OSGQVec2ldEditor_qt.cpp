...
void
QVec2ldEditor::addFieldElem(FieldContainerPtr pFC,          UInt32 uiFieldId,
                           UInt32            uiValueIndex                   )
{
...
void
QVec2ldEditor::removeFieldElem(FieldContainerPtr pFC,          UInt32 uiFieldId,
                              UInt32            uiValueIndex                   )
{
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGQVec2ldEditor_qt.cpp,v 1.4 2004/11/01 12:24:30 neumannc Exp $";
