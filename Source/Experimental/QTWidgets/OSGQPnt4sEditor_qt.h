...
class OSG_WINDOWQTLIB_DLLMAPPING QPnt4sEditor :
    public QVectorPointEditor<Pnt4s>
{
    Q_OBJECT
  ...
  private:
    typedef QVectorPointEditor<Pnt4s> Inherited;
...
//#include "OSGQPnt4sEditor.inl"

#define OSGQPNT4SEDITORQT_HEADER_CVSID "@(#)$Id: OSGQPnt4sEditor_qt.h,v 1.1 2004/07/30 15:32:14 neumannc Exp $"
