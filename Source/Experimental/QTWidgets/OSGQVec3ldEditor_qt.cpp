...
ValueEditorRegistrator _regVec3ld( FieldDataTraits<Vec3ld>::getType(),
                                 &QVec3ldEditor          ::create    );

QAbstractValueEditor *
QVec3ldEditor::create(QWidget *pParent, const char *name)
{
    return new QVec3ldEditor(pParent, name);
}

QVec3ldEditor::QVec3ldEditor(QWidget *pParent, const char *name)
...
QVec3ldEditor::~QVec3ldEditor(void)
{
}

void
QVec3ldEditor::setLabelsVisible(bool bLabels)
{
...
void
QVec3ldEditor::setReadOnly(bool bReadOnly)
{
...
void
QVec3ldEditor::readField(FieldContainerPtr pFC,          UInt32 uiFieldId,
...
void
QVec3ldEditor::writeField(FieldContainerPtr pFC,          UInt32 uiFieldId,
                         UInt32            uiValueIndex                   )
{
...
void
QVec3ldEditor::addFieldElem(FieldContainerPtr pFC,          UInt32 uiFieldId,
                           UInt32            uiValueIndex                   )
{
...
void
QVec3ldEditor::slotSpinBoxChanged(void)
{
    emit valueChanged(this);
}

void
QVec3ldEditor::initSelf(void)
{
...
#include "OSGQVec3ldEditor_qt_moc.cpp"
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGQVec3ldEditor_qt.cpp,v 1.5 2004/12/20 11:09:54 neumannc Exp $";
