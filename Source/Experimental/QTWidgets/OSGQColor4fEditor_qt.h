...
#ifndef _OSGQCOLOR4FEDITOR_QT_H_
#define _OSGQCOLOR4FEDITOR_QT_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_WINDOWQTLIB_DLLMAPPING QColor4fEditor : public QAbstractValueEditor
{
    Q_OBJECT
  ...
  public:
    ...
    QColor4fEditor(QWidget *pParent, const char *name);

    virtual ~QColor4fEditor(void);

    inline void getValue(      Color4f &color) const;
    inline void setValue(const Color4f &color);
