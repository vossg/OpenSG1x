...
class OSG_WINDOWQTLIB_DLLMAPPING QPnt4bEditor :
    public QVectorPointEditor<Pnt4b>
{
    Q_OBJECT
  ...
  private:
    typedef QVectorPointEditor<Pnt4b> Inherited;
...
#define OSGQPNT4BEDITORQT_HEADER_CVSID "@(#)$Id: OSGQPnt4bEditor_qt.h,v 1.1 2004/07/30 15:32:14 neumannc Exp $"
