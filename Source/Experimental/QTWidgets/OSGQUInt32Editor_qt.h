...
#ifndef _OSGQUINT32EDITOR_QT_H_
#define _OSGQUINT32EDITOR_QT_H_
#ifdef __sgi
#pragma once
#endif
    ...
    public QScalarTypeEditor<UInt32>
{
  ...
  public:
    ...
    QUInt32Editor(QWidget *pParent, const char *name);
...
#define OSGQUINT32EDITORQT_HEADER_CVSID "@(#)$Id: OSGQUInt32Editor_qt.h,v 1.1 2004/07/30 15:32:15 neumannc Exp $"
