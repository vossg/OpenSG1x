...
class OSG_WINDOWQTLIB_DLLMAPPING QVec2bEditor :
    public QVectorPointEditor<Vec2b>
{
    Q_OBJECT
  ...
  private:
    typedef QVectorPointEditor<Vec2b> Inherited;
...
#define OSGQVEC2BEDITORQT_HEADER_CVSID "@(#)$Id: OSGQVec2bEditor_qt.h,v 1.2 2004/08/06 16:16:03 neumannc Exp $"
