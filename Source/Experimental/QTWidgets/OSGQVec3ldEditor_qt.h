...
#ifndef _OSGQVEC3LDEDITOR_QT_H_
#define _OSGQVEC3LDEDITOR_QT_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_WINDOWQTLIB_DLLMAPPING QVec3ldEditor :
    public QAbstractValueEditor
{
  ...
  public:
    ...
    QVec3ldEditor(QWidget *pParent, const char *name);

    virtual ~QVec3ldEditor(void);
  ...
  private:
    ...
    QVectorPointEditorHelper<Vec3ld> _editHelper;
};
...
#define OSGQVEC3LDEDITORQT_HEADER_CVSID "@(#)$Id: OSGQVec3ldEditor_qt.h,v 1.3 2004/11/01 12:24:30 neumannc Exp $"
