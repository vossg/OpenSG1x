...
QSpinBoxInt32::QSpinBoxInt32(QWidget *pParent, const char *name)
    : Inherited    (pParent, name),
      _bTextChanged(false        ),
      _spinHelper  (             ),
      _pSpinWidget (NULL         )
{
    _pSpinWidget = new QSpinWidget(this, "QSpinBoxInt32::_pSpinWidget");
...
QSpinBoxInt32::~QSpinBoxInt32(void)
{
}

std::string
QSpinBoxInt32::getValueByStr(void) const
{
    return _spinHelper.getValueByStr();
}

bool
QSpinBoxInt32::getWrapAround(void) const
{
    return _spinHelper.getWrapAround();
}

void
QSpinBoxInt32::setWrapAround(bool bWrapAround)
{
    _spinHelper.setWrapAround(bWrapAround);
}

void
QSpinBoxInt32::setReadOnly(bool bReadOnly)
{
...
void
QSpinBoxInt32::setValueByStr(const std::string &strValue)
{
...
void
QSpinBoxInt32::stepPageDown(void)
{
...
void
QSpinBoxInt32::slotTextChanged(void)
{
    _bTextChanged = true;
}

void
QSpinBoxInt32::slotReturnPressed(void)
{
...
void
QSpinBoxInt32::updateDisplay(void)
{
...
void
QSpinBoxInt32::resizeEvent(QResizeEvent *pResizeEvent)
{
    _pSpinWidget->resize(pResizeEvent->size());
}

void
QSpinBoxInt32::wheelEvent(QWheelEvent *pWheelEvent)
{
...
bool
QSpinBoxInt32::eventFilter(QObject *pObj, QEvent *pEvent)
{
    bool retValue = false;
...
#include "OSGQSpinBoxInt32_qt_moc.cpp"
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGQSpinBoxInt32_qt.cpp,v 1.1 2004/07/30 15:32:15 neumannc Exp $";
    static Char8 cvsid_hpp       [] = OSGQSPINBOXINT32QT_HEADER_CVSID;
    static Char8 cvsid_inl       [] = OSGQSPINBOXINT32QT_INLINE_CVSID;
}
