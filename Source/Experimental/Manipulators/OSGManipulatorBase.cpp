...
FieldDescription *ManipulatorBase::_desc[] = 
{
    new FieldDescription(SFNodePtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFTarget)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "activeSubHandle", 
                     ActiveSubHandleFieldId, ActiveSubHandleFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFActiveSubHandle)),
    new FieldDescription(SFPnt2f::getClassType(), 
                     "lastMousePos", 
                     LastMousePosFieldId, LastMousePosFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFLastMousePos)),
    new FieldDescription(SFViewportPtr::getClassType(), 
                     "viewport", 
                     ViewportFieldId, ViewportFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFViewport)),
    new FieldDescription(SFBool::getClassType(), 
                     "active", 
                     ActiveFieldId, ActiveFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFActive)),
    new FieldDescription(SFVec3f::getClassType(), 
                     "length", 
                     LengthFieldId, LengthFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFLength)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "handleXNode", 
                     HandleXNodeFieldId, HandleXNodeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFHandleXNode)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "handleYNode", 
                     HandleYNodeFieldId, HandleYNodeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFHandleYNode)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "handleZNode", 
                     HandleZNodeFieldId, HandleZNodeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFHandleZNode)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "transXNode", 
                     TransXNodeFieldId, TransXNodeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFTransXNode)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "transYNode", 
                     TransYNodeFieldId, TransYNodeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFTransYNode)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "transZNode", 
                     TransZNodeFieldId, TransZNodeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFTransZNode)),
    new FieldDescription(SFMaterialPtr::getClassType(), 
                     "materialX", 
                     MaterialXFieldId, MaterialXFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFMaterialX)),
    new FieldDescription(SFMaterialPtr::getClassType(), 
                     "materialY", 
                     MaterialYFieldId, MaterialYFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFMaterialY)),
    new FieldDescription(SFMaterialPtr::getClassType(), 
                     "materialZ", 
                     MaterialZFieldId, MaterialZFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFMaterialZ)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "axisLinesN", 
                     AxisLinesNFieldId, AxisLinesNFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ManipulatorBase::editSFAxisLinesN))
};
