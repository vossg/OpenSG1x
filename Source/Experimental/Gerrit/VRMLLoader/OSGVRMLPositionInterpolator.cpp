...
static void vrmlPositionInterpolatorDescInserter(ReflexiveContainerType *pType)
{
    ...
    pDesc = new DataElementDesc(
        ...
        "set_fraction",
        OSG_RC_ELEM_IDM_DESC(VRMLPositionInterpolator::SetFractionField),
        false,
        (DataElemGetMethod) &VRMLPositionInterpolator::getSFSetFraction,
        NULL,
        NULL);
    ...
    pDesc = new DataElementDesc(
        ...
        "value_changed",
        OSG_RC_ELEM_IDM_DESC(VRMLPositionInterpolator::ValueChangedField),
        false,
        (DataElemGetMethod) &VRMLPositionInterpolator::getSFValueChanged,
        NULL,
        NULL);
...
SFReal32 *VRMLPositionInterpolator::getSFSetFraction(void)
{
    return &_sfSetFraction;
}

SFVec3f *VRMLPositionInterpolator::getSFValueChanged(void)
{
...
namespace
{
    static Char8 cvsid_cpp[] = "@(#)$Id: OSGVRMLPositionInterpolator.cpp,v 1.1 2004/03/05 17:36:07 a-m-z Exp $";
