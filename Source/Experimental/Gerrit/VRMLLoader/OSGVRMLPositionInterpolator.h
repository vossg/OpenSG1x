...
#ifndef _OSGVRMLPOSITIONINTERPOLATOR_HPP_
#define _OSGVRMLPOSITIONINTERPOLATOR_HPP_
#ifdef __sgi
#pragma once
#endif
...
//! Brief VRMLPositionInterpolator
//! \ingroup VRMLNodeLib

class OSG_VRML_DLLMAPPING VRMLPositionInterpolator : public VRMLUnlimitedNode
{
  private:
  ...
  public:
    ...
    typedef       VRMLPositionInterpolator *Ptr;
    typedef const VRMLPositionInterpolator *ConstPtr;
