...
FieldDescription *ShadingGroupPAttachmentDesc::_desc[] =
{
    new FieldDescription(
        ...
        OSG_FC_FIELD_IDM_DESC(
            SimpleAttachment<ShadingGroupPAttachmentDesc>::SimpleField),
        false,
        (FieldAccessMethod) &SimpleAttachment<
                                  ShadingGroupPAttachmentDesc>::getFieldPtr)
};
...
namespace
{
    ...
    static Char8 cvsid_hpp[] = OSGSHADINGGROUPATTACHMENT_HEADER_CVSID;
}
