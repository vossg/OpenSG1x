...
FieldDescription *ShaderParameterVec2fBase::_desc[] = 
{
    new FieldDescription(SFVec2f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterVec2fBase::editSFValue))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterVec2fBase.cpp,v 1.9 2008/06/09 12:28:06 vossg Exp $";
