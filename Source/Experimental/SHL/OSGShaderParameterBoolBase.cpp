...
FieldDescription *ShaderParameterBoolBase::_desc[] = 
{
    new FieldDescription(SFBool::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterBoolBase::editSFValue))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterBoolBase.cpp,v 1.9 2008/06/09 12:28:05 vossg Exp $";
