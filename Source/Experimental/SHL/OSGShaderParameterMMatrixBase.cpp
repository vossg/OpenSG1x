...
FieldDescription *ShaderParameterMMatrixBase::_desc[] = 
{
    new FieldDescription(MFMatrix::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterMMatrixBase::editMFValue))
};
...
FieldContainerType ShaderParameterMMatrixBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterMMatrixBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterMMatrixBase *>(&other),
                          whichField);
}
#else
void ShaderParameterMMatrixBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterMMatrixBase.cpp,v 1.4 2008/06/09 12:28:05 vossg Exp $";
