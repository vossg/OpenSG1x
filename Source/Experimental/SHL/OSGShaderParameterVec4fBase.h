...
class OSG_SYSTEMLIB_DLLMAPPING ShaderParameterVec4fBase : public ShaderParameter
{
  ...
  protected:
    ...
    void executeSyncImpl(      ShaderParameterVec4fBase *pOther,
                         const BitVector         &whichField);
...
typedef osgIF<ShaderParameterVec4fBase::isNodeCore,
...
#define OSGSHADERPARAMETERVEC4FBASE_HEADER_CVSID "@(#)$Id: OSGShaderParameterVec4fBase.h,v 1.5 2005/07/20 00:08:59 vossg Exp $"
