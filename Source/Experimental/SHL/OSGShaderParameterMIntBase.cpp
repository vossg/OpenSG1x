...
FieldDescription *ShaderParameterMIntBase::_desc[] = 
{
    new FieldDescription(MFInt32::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterMIntBase::editMFValue))
};
...
FieldContainerType ShaderParameterMIntBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterMIntBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterMIntBase *>(&other),
                          whichField);
}
#else
void ShaderParameterMIntBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterMIntBase.cpp,v 1.4 2008/06/09 12:28:05 vossg Exp $";
