...
FieldDescription *ShaderParameterChunkBase::_desc[] = 
{
    new FieldDescription(MFShaderParameterPtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterChunkBase::editMFParameters))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterChunkBase.cpp,v 1.9 2008/06/09 12:28:05 vossg Exp $";
