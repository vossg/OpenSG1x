...
FieldDescription *ShaderParameterMVec2fBase::_desc[] = 
{
    new FieldDescription(MFVec2f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterMVec2fBase::editMFValue))
};
...
FieldContainerType ShaderParameterMVec2fBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterMVec2fBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterMVec2fBase *>(&other),
                          whichField);
}
#else
void ShaderParameterMVec2fBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterMVec2fBase.cpp,v 1.4 2008/06/09 12:28:05 vossg Exp $";
