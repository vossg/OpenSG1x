...
FieldDescription *ShaderParameterVec4fBase::_desc[] = 
{
    new FieldDescription(SFVec4f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterVec4fBase::editSFValue))
};
...
FieldContainerType ShaderParameterVec4fBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterVec4fBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterVec4fBase *>(&other),
                          whichField);
}
#else
void ShaderParameterVec4fBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterVec4fBase.cpp,v 1.9 2008/06/09 12:28:06 vossg Exp $";
