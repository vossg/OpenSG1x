...
FieldDescription *ShaderParameterIntBase::_desc[] = 
{
    new FieldDescription(SFInt32::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterIntBase::editSFValue))
};
...
FieldContainerType ShaderParameterIntBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterIntBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterIntBase *>(&other),
                          whichField);
}
#else
void ShaderParameterIntBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterIntBase.cpp,v 1.9 2008/06/09 12:28:05 vossg Exp $";
