...
FieldDescription *ShaderParameterRealBase::_desc[] = 
{
    new FieldDescription(SFReal32::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterRealBase::editSFValue))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterRealBase.cpp,v 1.9 2008/06/09 12:28:06 vossg Exp $";
