...
FieldDescription *ShaderParameterVec3fBase::_desc[] = 
{
    new FieldDescription(SFVec3f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterVec3fBase::editSFValue))
};
...
FieldContainerType ShaderParameterVec3fBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterVec3fBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterVec3fBase *>(&other),
                          whichField);
}
#else
void ShaderParameterVec3fBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterVec3fBase.cpp,v 1.9 2008/06/09 12:28:06 vossg Exp $";
