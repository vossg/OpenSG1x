...
FieldDescription *ShaderParameterMatrixBase::_desc[] = 
{
    new FieldDescription(SFMatrix::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterMatrixBase::editSFValue))
};
...
FieldContainerType ShaderParameterMatrixBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterMatrixBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterMatrixBase *>(&other),
                          whichField);
}
#else
void ShaderParameterMatrixBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterMatrixBase.cpp,v 1.9 2008/06/09 12:28:06 vossg Exp $";
