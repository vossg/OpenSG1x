...
FieldDescription *ShaderParameterMVec4fBase::_desc[] = 
{
    new FieldDescription(MFVec4f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ShaderParameterMVec4fBase::editMFValue))
};
...
FieldContainerType ShaderParameterMVec4fBase::_type(
    ...
    "ShaderParameter",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&ShaderParameterMVec4fBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<ShaderParameterMVec4fBase *>(&other),
                          whichField);
}
#else
void ShaderParameterMVec4fBase::executeSync(      FieldContainer &other,
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGShaderParameterMVec4fBase.cpp,v 1.4 2008/06/09 12:28:05 vossg Exp $";
