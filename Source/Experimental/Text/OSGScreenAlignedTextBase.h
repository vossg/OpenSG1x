...
#include <OSGImagePFields.h> // RenderImage type
...
class OSG_SYSTEMLIB_DLLMAPPING ScreenAlignedTextBase : public AbstractText
{
  ...
  protected:
    ...
    /*! \{                                                                 */
           ...
           SFImageP            *getSFRenderImage    (void);

           ImageP              &getRenderImage    (void);
     const ImageP              &getRenderImage    (void) const;
    ...
    /*! \{                                                                 */
     ...
     void setRenderImage    (const ImageP &value);
