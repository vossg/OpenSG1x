    ...
    QPainter *pPainter, const QColorGroup &colGrp, const QRect &rect)
{
    ...
    for(UInt32 row = 0; row < 4; ++row)
    {
        ...
        for(UInt32 col = 0; col < 4; ++col)
        {
            ...
            pPainter->drawText (drawRect, AlignVCenter, 
...
#define OSGQMATRIXFIELDVALUELABEL_INLINE_CVSID "@(#)$Id: OSGQMatrixFieldValueLabel.inl,v 1.3 2003/05/19 07:36:41 neumannc Exp $"
