...
typedef FCPtr<WindowPtr, CarbonWindow> CarbonWindowPtr;
...
#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<CarbonWindowPtr, true>
    \hideinhierarchy
 */
#endif
...
typedef SField<CarbonWindowPtr> SFCarbonWindowPtr;
#endif

#ifndef OSG_COMPILECARBONWINDOWINST
OSG_DLLEXPORT_DECL1(SField, CarbonWindowPtr, OSG_WINDOWCARBONLIB_DLLTMPLMAPPING)
#endif

#if !defined(OSG_DO_DOC) || defined(OSG_DOC_FIELD_TYPEDEFS)
/*! \ingroup GrpWindowCarbonFieldMulti */

typedef MField<CarbonWindowPtr> MFCarbonWindowPtr;
#endif

#ifndef OSG_COMPILECARBONWINDOWINST
OSG_DLLEXPORT_DECL1(MField, CarbonWindowPtr, OSG_WINDOWCARBONLIB_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGCARBONWINDOWFIELDS_HEADER_CVSID "@(#)$Id: OSGCarbonWindowFields.h,v 1.4 2008/06/09 12:28:26 vossg Exp $"
