...
class OSG_WINDOWCOCOALIB_DLLMAPPING CocoaWindowBase : public Window
{
  private:
  ...
  protected:
    ...
    void executeSyncImpl(      CocoaWindowBase *pOther,
                         const BitVector         &whichField);
...
typedef osgIF<CocoaWindowBase::isNodeCore,
              CoredNodePtr<CocoaWindow>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet CocoaWindowNodePtr;

typedef RefPtr<CocoaWindowPtr> CocoaWindowRefPtr;

OSG_END_NAMESPACE

#define OSGCOCOAWINDOWBASE_HEADER_CVSID "@(#)$Id: OSGCocoaWindowBase.h,v 1.4 2008/06/09 12:28:27 vossg Exp $"
