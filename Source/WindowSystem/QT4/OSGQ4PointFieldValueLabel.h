...
class OSG_WINDOWQTLIB_DLLTMPLMAPPING QPointFieldValueLabel : 
...
#define OSGQPOINTFIELDVALUELABEL_HEADER_CVSID "@(#)$Id: OSGQ4PointFieldValueLabel.h,v 1.1 2006/03/10 18:30:35 a-m-z Exp $"

#include "OSGQ4PointFieldValueLabel.inl"
