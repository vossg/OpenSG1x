...
class OSG_WINDOWQTLIB_DLLTMPLMAPPING QVectorFieldValueLabel : 
...
#define OSGQVECTORFIELDVALUELABEL_HEADER_CVSID "@(#)$Id: OSGQ4VectorFieldValueLabel.h,v 1.1 2006/03/10 18:30:35 a-m-z Exp $"

#include "OSGQ4VectorFieldValueLabel.inl"
