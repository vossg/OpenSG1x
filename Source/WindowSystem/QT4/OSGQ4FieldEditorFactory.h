...
class OSG_WINDOWQTLIB_DLLMAPPING QFieldEditorFactory
{
public:
...
#define OSGQFIELDEDITORFACTORY_HEADER_CVSID "@(#)$Id: OSGQ4FieldEditorFactory.h,v 1.1 2006/03/10 18:30:35 a-m-z Exp $"
