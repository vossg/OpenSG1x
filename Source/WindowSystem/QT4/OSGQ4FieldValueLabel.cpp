...
namespace
{
    static Char8 cvsid_cpp[] = "@(#)$Id: OSGQ4FieldValueLabel.cpp,v 1.1 2006/03/10 18:30:35 a-m-z Exp $";
                                                   ...
                                                   const QRect       &rect)
{
        ...
        (rect.height() < sizeHint().height())   )
    {
		...
		pPainter->drawText(rect, Qt::AlignVCenter, getCachedValue());
    }
    else
    {
		...
		pPainter->drawText(rectText, Qt::AlignVCenter, getCachedValue());
    }
