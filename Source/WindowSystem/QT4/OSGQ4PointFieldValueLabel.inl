    ...
    QPainter *pPainter, const QColorGroup &colGrp, const QRect &rect)
{
    ...
    for(UInt32 i=0; i < PointType::_iSize; ++i)
    {
        ...
        pPainter->drawText(drawRect, Qt::AlignVCenter, getCachedValue(i));
...
#define OSGQPOINTFIELDVALUELABEL_INLINE_CVSID "@(#)$Id: OSGQ4PointFieldValueLabel.inl,v 1.2 2007/02/26 13:37:38 yjung Exp $"
