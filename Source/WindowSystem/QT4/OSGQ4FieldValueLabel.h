...
class OSG_WINDOWQTLIB_DLLMAPPING QFieldValueLabelBase //: public Qt
{
public:
...
class OSG_WINDOWQTLIB_DLLMAPPING QGenericFieldValueLabel : 
...
#define OSGQFIELDVALUELABEL_HEADER_CVSID "@(#)$Id: OSGQ4FieldValueLabel.h,v 1.1 2006/03/10 18:30:35 a-m-z Exp $"

#include "OSGQ4FieldValueLabel.inl"
