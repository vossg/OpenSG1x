...
typedef osgIF<GLUTWindowBase::isNodeCore,
              CoredNodePtr<GLUTWindow>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet GLUTWindowNodePtr;

typedef RefPtr<GLUTWindowPtr> GLUTWindowRefPtr;

OSG_END_NAMESPACE

#define OSGGLUTWINDOWBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.40 2005/07/20 00:10:14 vossg Exp $"
