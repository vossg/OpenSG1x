...
public:
    ...
    ClusterServerGLWidget(const QGLFormat &format, QWidget *parent = 0, const char *name = 0, WFlags f = 0);
...
ClusterServerGLWidget::ClusterServerGLWidget(const QGLFormat &format, QWidget *parent, const char *name , WFlags f) :
    ...
    try
    {
        if(stereobuffer)
        {
            window = new ClusterServerGLWidget(QGLFormat(QGL::DirectRendering | QGL::DoubleBuffer |
                                            ...
                                            NULL, "ClusterRender", noborder ? QWidget::WStyle_Customize  | QWidget::WStyle_NoBorder | QWidget::WStyle_StaysOnTop : 0);
        }
        else
        {
            window = new ClusterServerGLWidget(QGLFormat(QGL::DirectRendering | QGL::DoubleBuffer |
                                            QGL::DepthBuffer | QGL::Rgba), NULL, "ClusterRender",
                                            noborder ? QWidget::WStyle_Customize  | QWidget::WStyle_NoBorder | QWidget::WStyle_StaysOnTop : 0);
        }
