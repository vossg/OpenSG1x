...
inline
void BoxVolume::getBounds(Real32 &xmin, Real32 &ymin, Real32 &zmin,
                          Real32 &xmax, Real32 &ymax, Real32 &zmax) const
{
...
inline
void BoxVolume::getSize(Real32 &sizeX, Real32 &sizeY, Real32 &sizeZ) const
{
    sizeX = _max[0] - _min[0];
    sizeY = _max[1] - _min[1];
    sizeZ = _max[2] - _min[2];
...
inline
void BoxVolume::setBounds(Real32 xmin, Real32 ymin, Real32 zmin,
                          Real32 xmax, Real32 ymax, Real32 zmax)
{
