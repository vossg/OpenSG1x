...
FieldDescription *PhysicsBoxGeomBase::_desc[] = 
{
    new FieldDescription(SFVec3f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&PhysicsBoxGeomBase::editSFLenghts))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGPhysicsBoxGeomBase.cpp,v 1.5 2008/06/09 12:28:02 vossg Exp $";
