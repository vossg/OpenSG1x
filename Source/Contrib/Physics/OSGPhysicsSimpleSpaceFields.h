    ...
    public FieldTraitsRecurseMapper<PhysicsSimpleSpacePtr, true>
{
    ...
    static char     *getSName(void) { return "SFPhysicsSimpleSpacePtr"; }
    static char     *getMName(void) { return "MFPhysicsSimpleSpacePtr"; }
};
...
OSG_DLLEXPORT_DECL1(SField, PhysicsSimpleSpacePtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif
...
#ifndef OSG_COMPILEPHYSICSSIMPLESPACEINST
OSG_DLLEXPORT_DECL1(MField, PhysicsSimpleSpacePtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGPHYSICSSIMPLESPACEFIELDS_HEADER_CVSID "@(#)$Id: OSGPhysicsSimpleSpaceFields.h,v 1.1 2005/10/21 15:44:25 a-m-z Exp $"
