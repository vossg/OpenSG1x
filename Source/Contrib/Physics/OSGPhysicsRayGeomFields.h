    ...
    public FieldTraitsRecurseMapper<PhysicsRayGeomPtr, true>
{
    ...
    static char     *getSName(void) { return "SFPhysicsRayGeomPtr"; }
    static char     *getMName(void) { return "MFPhysicsRayGeomPtr"; }
};
...
OSG_DLLEXPORT_DECL1(SField, PhysicsRayGeomPtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif
...
#ifndef OSG_COMPILEPHYSICSRAYGEOMINST
OSG_DLLEXPORT_DECL1(MField, PhysicsRayGeomPtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGPHYSICSRAYGEOMFIELDS_HEADER_CVSID "@(#)$Id: OSGPhysicsRayGeomFields.h,v 1.1 2005/10/21 15:44:25 a-m-z Exp $"
