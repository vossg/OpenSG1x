    ...
    public FieldTraitsRecurseMapper<PhysicsHingeJointPtr, true>
{
    ...
    static char     *getSName(void) { return "SFPhysicsHingeJointPtr"; }
    static char     *getMName(void) { return "MFPhysicsHingeJointPtr"; }
};
...
OSG_DLLEXPORT_DECL1(SField, PhysicsHingeJointPtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif
...
#ifndef OSG_COMPILEPHYSICSHINGEJOINTINST
OSG_DLLEXPORT_DECL1(MField, PhysicsHingeJointPtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGPHYSICSHINGEJOINTFIELDS_HEADER_CVSID "@(#)$Id: OSGPhysicsHingeJointFields.h,v 1.1 2005/10/21 15:44:25 a-m-z Exp $"
