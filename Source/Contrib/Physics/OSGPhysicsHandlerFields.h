    ...
    public FieldTraitsRecurseMapper<PhysicsHandlerPtr, true>
{
    ...
    static char     *getSName(void) { return "SFPhysicsHandlerPtr"; }
    static char     *getMName(void) { return "MFPhysicsHandlerPtr"; }
};
...
OSG_DLLEXPORT_DECL1(SField, PhysicsHandlerPtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif
...
#ifndef OSG_COMPILEPHYSICSHANDLERINST
OSG_DLLEXPORT_DECL1(MField, PhysicsHandlerPtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGPHYSICSHANDLERFIELDS_HEADER_CVSID "@(#)$Id: OSGPhysicsHandlerFields.h,v 1.1 2005/10/21 15:44:25 a-m-z Exp $"
