    ...
    public FieldTraitsRecurseMapper<PhysicsSpacePtr, true>
{
    ...
    static char     *getSName(void) { return "SFPhysicsSpacePtr"; }
    static char     *getMName(void) { return "MFPhysicsSpacePtr"; }
};
...
OSG_DLLEXPORT_DECL1(SField, PhysicsSpacePtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif
...
#ifndef OSG_COMPILEPHYSICSSPACEINST
OSG_DLLEXPORT_DECL1(MField, PhysicsSpacePtr, OSG_CONTRIBLIB_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGPHYSICSSPACEFIELDS_HEADER_CVSID "@(#)$Id: OSGPhysicsSpaceFields.h,v 1.1 2005/10/21 15:44:25 a-m-z Exp $"
