...
class OSG_CONTRIBLIB_DLLMAPPING PhysicsJointBase : public Attachment
{
  private:
...
#define OSGPHYSICSJOINTBASE_HEADER_CVSID "@(#)$Id: OSGPhysicsJointBase.h,v 1.1 2005/10/21 15:44:25 a-m-z Exp $"
