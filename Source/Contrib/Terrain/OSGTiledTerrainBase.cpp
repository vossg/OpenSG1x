...
FieldDescription *TiledTerrainBase::_desc[] = 
{
    new FieldDescription(MFImagePtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editMFHeightTiles)),
    new FieldDescription(MFMaterialPtr::getClassType(), 
                     "heightTextures", 
                     HeightTexturesFieldId, HeightTexturesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editMFHeightTextures)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "sizeX", 
                     SizeXFieldId, SizeXFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFSizeX)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "sizeY", 
                     SizeYFieldId, SizeYFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFSizeY)),
    new FieldDescription(SFReal32::getClassType(), 
                     "heightScale", 
                     HeightScaleFieldId, HeightScaleFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFHeightScale)),
    new FieldDescription(SFReal32::getClassType(), 
                     "vertexSpacing", 
                     VertexSpacingFieldId, VertexSpacingFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFVertexSpacing)),
    new FieldDescription(SFBool::getClassType(), 
                     "geoMorphing", 
                     GeoMorphingFieldId, GeoMorphingFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFGeoMorphing)),
    new FieldDescription(SFReal32::getClassType(), 
                     "detail", 
                     DetailFieldId, DetailFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFDetail)),
    new FieldDescription(SFInt32::getClassType(), 
                     "currentX", 
                     CurrentXFieldId, CurrentXFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFCurrentX)),
    new FieldDescription(SFInt32::getClassType(), 
                     "currentY", 
                     CurrentYFieldId, CurrentYFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFCurrentY)),
    new FieldDescription(SFInt32::getClassType(), 
                     "sizeROI", 
                     SizeROIFieldId, SizeROIFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFSizeROI)),
    new FieldDescription(SFBool::getClassType(), 
                     "update", 
                     UpdateFieldId, UpdateFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFUpdate)),
    new FieldDescription(SFBool::getClassType(), 
                     "updateTerrain", 
                     UpdateTerrainFieldId, UpdateTerrainFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFUpdateTerrain)),
    new FieldDescription(SFBool::getClassType(), 
                     "perPixelLighting", 
                     PerPixelLightingFieldId, PerPixelLightingFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&TiledTerrainBase::editSFPerPixelLighting))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGTiledTerrainBase.cpp,v 1.10 2008/06/09 12:28:04 vossg Exp $";
