    ...
    public FieldTraitsRecurseMapper<CGChunkPtr, true>
{
    ...
    static const char *getSName(void) { return "SFCGChunkPtr"; }
    static const char *getMName(void) { return "MFCGChunkPtr"; }
};
...
#define OSGCGCHUNKFIELDS_HEADER_CVSID "@(#)$Id: FCFieldsTemplate_h.h,v 1.25 2005/04/04 14:51:48 dirk Exp $"
