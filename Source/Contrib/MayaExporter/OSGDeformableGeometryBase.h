...
#ifndef _OSGDEFORMABLEGEOMETRYBASE_H_
#define _OSGDEFORMABLEGEOMETRYBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief DeformableGeometry Base Class.

class OSG_CONTRIBLIB_DLLMAPPING DeformableGeometryBase : public Geometry
{
  private:
  ...
  public:
    ...
    enum
    {
        DeformersFieldId     = Inherited::NextFieldId,
        BasePositionsFieldId = DeformersFieldId     + 1,
        BaseNormalsFieldId   = BasePositionsFieldId + 1,
        NextFieldId          = BaseNormalsFieldId   + 1
    };

    static const OSG::BitVector DeformersFieldMask;
    ...
    static  DeformableGeometryPtr      create          (void); 
    static  DeformableGeometryPtr      createEmpty     (void); 
  ...
  protected:
    ...
    DeformableGeometryBase(void);
    DeformableGeometryBase(const DeformableGeometryBase &source);
    ...
    virtual ~DeformableGeometryBase(void); 
    ...
    void executeSyncImpl(      DeformableGeometryBase *pOther,
                         const BitVector         &whichField);
  ...
  private:
    ...
    void operator =(const DeformableGeometryBase &source);
};
...
typedef RefPtr<DeformableGeometryPtr> DeformableGeometryRefPtr;

OSG_END_NAMESPACE

#define OSGDEFORMABLEGEOMETRYBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.38 2005/07/08 06:37:35 vossg Exp $"
