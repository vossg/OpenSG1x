...
inline
OSG::FieldContainerType &DeformerBase::getClassType(void)
{
    return _type; 
} 
...
inline
OSG::UInt32 DeformerBase::getClassTypeId(void) 
{
    return _type.getId(); 
} 
...
//! Get the value of the Deformer::_sfGeometry field.
inline
const NodePtr &DeformerBase::getGeometry(void) const
{
    return _sfGeometry.getValue();
}
...
inline
void DeformerBase::setGeometry(const NodePtr &value)
{
...
#define OSGDEFORMERBASE_INLINE_CVSID "@(#)$Id: FCBaseTemplate_inl.h,v 1.21 2008/06/09 07:30:44 vossg Exp $"
