    ...
    public FieldTraitsRecurseMapper<DeformerPtr, true>
{
    ...
    static char     *getSName(void) { return "SFDeformerPtr"; }
    static char     *getMName(void) { return "MFDeformerPtr"; }
};
...
#define OSGDEFORMERFIELDS_HEADER_CVSID "@(#)$Id: FCFieldsTemplate_h.h,v 1.23 2003/07/11 18:39:08 dirk Exp $"
