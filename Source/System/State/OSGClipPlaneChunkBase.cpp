...
FieldDescription *ClipPlaneChunkBase::_desc[] = 
{
    new FieldDescription(SFVec4f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClipPlaneChunkBase::editSFEquation)),
    new FieldDescription(SFBool::getClassType(), 
                     "enable", 
                     EnableFieldId, EnableFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClipPlaneChunkBase::editSFEnable)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "beacon", 
                     BeaconFieldId, BeaconFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClipPlaneChunkBase::editSFBeacon))
};
