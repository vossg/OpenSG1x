...
typedef osgIF<StateChunkBase::isNodeCore,
              CoredNodePtr<StateChunk>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet StateChunkNodePtr;

typedef RefPtr<StateChunkPtr> StateChunkRefPtr;

OSG_END_NAMESPACE

#define OSGSTATECHUNKBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.40 2005/07/20 00:10:14 vossg Exp $"
