    ...
    public FieldTraitsRecurseMapper<SClipPlaneChunkPtr, true>
{
    ...
    static const char *getSName(void) { return "SFSClipPlaneChunkPtr"; }
    static const char *getMName(void) { return "MFSClipPlaneChunkPtr"; }
};
...
#define OSGSCLIPPLANECHUNKFIELDS_HEADER_CVSID "@(#)$Id: OSGSClipPlaneChunkFields.h,v 1.1 2007/04/26 15:22:01 a-m-z Exp $"
