...
class OSG_SYSTEMLIB_DLLMAPPING ShadeModelChunk : public ShadeModelChunkBase
{
  private:
...
#define OSGSHADEMODELCHUNK_HEADER_CVSID "@(#)$Id: OSGShadeModelChunk.h,v 1.1 2008/08/04 02:39:05 vossg Exp $"
