    ...
    public FieldTraitsRecurseMapper<PolygonChunkPtr, true>
{
    ...
    static char     *getSName(void) { return "SFPolygonChunkPtr"; }
    static char     *getMName(void) { return "MFPolygonChunkPtr"; }
};
...
#define OSGPOLYGONCHUNKFIELDS_HEADER_CVSID "@(#)$Id: FCFieldsTemplate_h.h,v 1.24 2004/08/03 05:53:03 dirk Exp $"
