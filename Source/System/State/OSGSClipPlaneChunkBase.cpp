...
FieldDescription *SClipPlaneChunkBase::_desc[] = 
{
    new FieldDescription(SFVec4f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SClipPlaneChunkBase::editSFEquation))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGSClipPlaneChunkBase.cpp,v 1.4 2008/06/09 12:28:21 vossg Exp $";
