...
typedef osgIF<VertexProgramChunkBase::isNodeCore,
              CoredNodePtr<VertexProgramChunk>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet VertexProgramChunkNodePtr;

typedef RefPtr<VertexProgramChunkPtr> VertexProgramChunkRefPtr;

OSG_END_NAMESPACE

#define OSGVERTEXPROGRAMCHUNKBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.38 2005/07/08 06:37:35 vossg Exp $"
