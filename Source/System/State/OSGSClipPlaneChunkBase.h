...
class OSG_SYSTEMLIB_DLLMAPPING SClipPlaneChunkBase : public StateChunk
{
  ...
  protected:
    ...
    void executeSyncImpl(      SClipPlaneChunkBase *pOther,
                         const BitVector         &whichField);
...
typedef osgIF<SClipPlaneChunkBase::isNodeCore,
              CoredNodePtr<SClipPlaneChunk>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet SClipPlaneChunkNodePtr;

typedef RefPtr<SClipPlaneChunkPtr> SClipPlaneChunkRefPtr;

OSG_END_NAMESPACE

#define OSGSCLIPPLANECHUNKBASE_HEADER_CVSID "@(#)$Id: OSGSClipPlaneChunkBase.h,v 1.4 2008/06/09 12:28:21 vossg Exp $"
