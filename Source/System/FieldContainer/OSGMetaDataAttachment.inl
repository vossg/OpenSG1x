...
inline const MFString& MetaDataAttachment::getKeys() const
{
...
inline bool MetaDataAttachment::hasAttribute(const std::string& key) const
{
...
inline const std::string MetaDataAttachment::getAttribute(
...
inline std::string& MetaDataAttachment::operator[](const std::string& key)
{
...
#define OSGMETADATAATTACHMENT_INLINE_CVSID "@(#)$Id: OSGMetaDataAttachment.inl,v 1.3 2008/06/09 07:30:36 vossg Exp $"
