...
void BinarySwapComposer::sendToClient(DepthT &depth,ColorT &color,
                                      UInt32 left,
                                      UInt32 bottom,
                                      UInt32 right,
                                      UInt32 top)
...
template<class DepthT,class ColorT>
void BinarySwapComposer::recvFromServers(DepthT &depth,ColorT &color,
                                         UInt32 colorType,
                                         UInt32 colorFormat,
                                         ViewportPtr port)
{
...
template<class DepthT,class ColorT>
void BinarySwapComposer::readCombine(DepthT &depth,ColorT &color,
                                     UInt32 colorType,
                                     UInt32 colorFormat,
                                     UInt32 left,
                                     UInt32 bottom,
...
template<class DepthT,class ColorT>
void BinarySwapComposer::startReader(DepthT &depthMax,ColorT &color,
                                     UInt32 depthFormat,
                                     UInt32 colorType,
                                     UInt32 colorFormat,
                                     ViewportPtr port)
