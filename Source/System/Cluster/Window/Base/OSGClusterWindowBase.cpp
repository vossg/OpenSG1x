...
FieldDescription *ClusterWindowBase::_desc[] = 
{
    new FieldDescription(MFString::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editMFServers)),
    new FieldDescription(SFString::getClassType(), 
                     "connectionType", 
                     ConnectionTypeFieldId, ConnectionTypeFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFConnectionType)),
    new FieldDescription(SFString::getClassType(), 
                     "connectionInterface", 
                     ConnectionInterfaceFieldId, ConnectionInterfaceFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFConnectionInterface)),
    new FieldDescription(SFString::getClassType(), 
                     "connectionDestination", 
                     ConnectionDestinationFieldId, ConnectionDestinationFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFConnectionDestination)),
    new FieldDescription(SFString::getClassType(), 
                     "connectionParams", 
                     ConnectionParamsFieldId, ConnectionParamsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFConnectionParams)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "servicePort", 
                     ServicePortFieldId, ServicePortFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFServicePort)),
    new FieldDescription(SFString::getClassType(), 
                     "serviceAddress", 
                     ServiceAddressFieldId, ServiceAddressFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFServiceAddress)),
    new FieldDescription(SFString::getClassType(), 
                     "serviceInterface", 
                     ServiceInterfaceFieldId, ServiceInterfaceFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFServiceInterface)),
    new FieldDescription(SFWindowPtr::getClassType(), 
                     "clientWindow", 
                     ClientWindowFieldId, ClientWindowFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFClientWindow)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "interleave", 
                     InterleaveFieldId, InterleaveFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFInterleave)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "frameCount", 
                     FrameCountFieldId, FrameCountFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFFrameCount)),
    new FieldDescription(SFImageComposerPtr::getClassType(), 
                     "composer", 
                     ComposerFieldId, ComposerFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFComposer)),
    new FieldDescription(MFString::getClassType(), 
                     "autostart", 
                     AutostartFieldId, AutostartFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editMFAutostart)),
    new FieldDescription(MFDisplayCalibrationPtr::getClassType(), 
                     "calibration", 
                     CalibrationFieldId, CalibrationFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editMFCalibration)),
    new FieldDescription(MFDisplayFilterForegroundPtr::getClassType(), 
                     "filter", 
                     FilterFieldId, FilterFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editMFFilter)),
    new FieldDescription(SFBool::getClassType(), 
                     "dirty", 
                     DirtyFieldId, DirtyFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ClusterWindowBase::editSFDirty))
};
