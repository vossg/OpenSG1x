...
FieldDescription *MatrixCameraBase::_desc[] = 
{
    new FieldDescription(SFMatrix::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&MatrixCameraBase::editSFProjectionMatrix)),
    new FieldDescription(SFMatrix::getClassType(), 
                     "ModelviewMatrix", 
                     ModelviewMatrixFieldId, ModelviewMatrixFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&MatrixCameraBase::editSFModelviewMatrix))
};
...
FieldContainerType MatrixCameraBase::_type(
    ...
    "Camera",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&MatrixCameraBase::createEmpty),
...
{
    this->executeSyncImpl(static_cast<MatrixCameraBase *>(&other),
                          whichField);
}
#else
void MatrixCameraBase::executeSync(      FieldContainer &other,
