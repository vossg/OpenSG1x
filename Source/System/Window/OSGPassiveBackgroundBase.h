...
typedef osgIF<PassiveBackgroundBase::isNodeCore,
              CoredNodePtr<PassiveBackground>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet PassiveBackgroundNodePtr;

typedef RefPtr<PassiveBackgroundPtr> PassiveBackgroundRefPtr;

OSG_END_NAMESPACE

#define OSGPASSIVEBACKGROUNDBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.41 2008/06/09 07:30:44 vossg Exp $"
