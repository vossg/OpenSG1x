...
typedef osgIF<PassiveViewportBase::isNodeCore,
              CoredNodePtr<PassiveViewport>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet PassiveViewportNodePtr;

typedef RefPtr<PassiveViewportPtr> PassiveViewportRefPtr;

OSG_END_NAMESPACE

#define OSGPASSIVEVIEWPORTBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.40 2005/07/20 00:10:14 vossg Exp $"
