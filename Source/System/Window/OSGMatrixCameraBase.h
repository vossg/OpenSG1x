...
typedef osgIF<MatrixCameraBase::isNodeCore,
              CoredNodePtr<MatrixCamera>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet MatrixCameraNodePtr;

typedef RefPtr<MatrixCameraPtr> MatrixCameraRefPtr;

OSG_END_NAMESPACE

#define OSGMATRIXCAMERABASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.41 2008/06/09 07:30:44 vossg Exp $"
