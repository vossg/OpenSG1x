...
FieldDescription *FBOViewportBase::_desc[] = 
{
    new FieldDescription(SFBool::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFEnabled)),
    new FieldDescription(MFNodePtr::getClassType(), 
                     "excludeNodes", 
                     ExcludeNodesFieldId, ExcludeNodesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getMFExcludeNodes)),
    new FieldDescription(MFNodePtr::getClassType(), 
                     "renderNodes", 
                     RenderNodesFieldId, RenderNodesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getMFRenderNodes)),
    new FieldDescription(MFTextureChunkPtr::getClassType(), 
                     "textures", 
                     TexturesFieldId, TexturesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getMFTextures)),
    new FieldDescription(SFBool::getClassType(), 
                     "fboOn", 
                     FboOnFieldId, FboOnFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFFboOn)),
    new FieldDescription(SFInt32::getClassType(), 
                     "storageWidth", 
                     StorageWidthFieldId, StorageWidthFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFStorageWidth)),
    new FieldDescription(SFInt32::getClassType(), 
                     "storageHeight", 
                     StorageHeightFieldId, StorageHeightFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFStorageHeight)),
    new FieldDescription(SFBool::getClassType(), 
                     "genCubemaps", 
                     GenCubemapsFieldId, GenCubemapsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFGenCubemaps)),
    new FieldDescription(SFBool::getClassType(), 
                     "genDepthmaps", 
                     GenDepthmapsFieldId, GenDepthmapsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFGenDepthmaps)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "frameBufferIndex", 
                     FrameBufferIndexFieldId, FrameBufferIndexFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFFrameBufferIndex)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "depthBufferIndex", 
                     DepthBufferIndexFieldId, DepthBufferIndexFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFDepthBufferIndex)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "stencilBufferIndex", 
                     StencilBufferIndexFieldId, StencilBufferIndexFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFStencilBufferIndex)),
    new FieldDescription(SFBool::getClassType(), 
                     "dirty", 
                     DirtyFieldId, DirtyFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFDirty)),
    new FieldDescription(SFBool::getClassType(), 
                     "readBuffer", 
                     ReadBufferFieldId, ReadBufferFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFReadBuffer)),
    new FieldDescription(SFBool::getClassType(), 
                     "ignoreCameraDecorators", 
                     IgnoreCameraDecoratorsFieldId, IgnoreCameraDecoratorsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFIgnoreCameraDecorators)),
    new FieldDescription(SFBool::getClassType(), 
                     "fboOffIgnoreStorageSize", 
                     FboOffIgnoreStorageSizeFieldId, FboOffIgnoreStorageSizeFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getSFFboOffIgnoreStorageSize)),
    new FieldDescription(MFInt32::getClassType(), 
                     "zOffset", 
                     ZOffsetFieldId, ZOffsetFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FBOViewportBase::getMFZOffset))
};
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGFBOViewportBase.cpp,v 1.5 2008/06/05 05:02:30 vossg Exp $";
