...
class OSG_SYSTEMLIB_DLLMAPPING PLYSceneFileType : public SceneFileType
{
public:
...
#define OSGPLYSCENEFILETYPE_HEADER_CVSID "@(#)$Id: OSGPLYSceneFileType.h,v 1.1 2005/05/05 21:30:36 aegis Exp $"
