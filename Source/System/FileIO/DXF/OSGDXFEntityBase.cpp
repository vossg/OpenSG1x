...
static Char8 const * const resultnames[]=
{
	"ERROR",
	"CONTINUE",
	"RETURN",
...
NodePtr     		 DXFEntityBase::_rootNodeP = NullFC;
NodePtr     		 DXFEntityBase::_activeNodeP = NullFC;

GeoPositions3dPtr    DXFEntityBase::_pointsP = NullFC;
MFPnt3d             *DXFEntityBase::_pointsF = NULL;
MFPnt3d::iterator    DXFEntityBase::_pointsIt;

GeoIndicesUI32Ptr    DXFEntityBase::_pointIndicesP = NullFC;
MFUInt32            *DXFEntityBase::_pointIndicesF = NULL;
MFUInt32::iterator   DXFEntityBase::_pointIndicesIt;

GeoPLengthsUI32Ptr   DXFEntityBase::_faceLengthP = NullFC;
MFUInt32            *DXFEntityBase::_faceLengthF = NULL;
MFUInt32::iterator   DXFEntityBase::_faceLengthIt;

GeoPTypesUI8Ptr      DXFEntityBase::_faceTypeP = NullFC;
...
void DXFEntityBase::registerToParentEntityType(const Char8 *parentEntityTypeName)
{
...
Color3f DXFEntityBase::getColor(Int16 colorNumber)
{
	...
	if( colorNumber < 0 )
	{
		color = Color3f( 1.0, 1.0, 1.0);  // TODO: colorNumber < 0 means invisible!
	}
	else
	{
 ...
 */
NodePtr DXFEntityBase::getNode(void)
{
	return NullFC;
}
 ...
 *
 *  \impl
 *  The method dispatch() assumes, that this method leaves with DXFEntityBase::_state set to
 *  DXFStateContinue or DXFStateError only.
 *
 *  \see dispatch()
 */
...
// 		}
	...
	if(_state == DXFStateReturn)		// TODO: we have to call endEntity in any case
								// for clean ups?
		_state = endEntity();
	
	if(_state != DXFStateError)		// endEntity() returns DXFStateError or DXFStateContinue!
...
namespace
{
static Char8 cvsid_cpp[] = "@(#)$Id: OSGDXFEntityBase.cpp,v 1.2 2005/10/14 08:33:35 a-m-z Exp $";
static Char8 cvsid_hpp[] = OSGDXFENTITYBASE_HEADER_CVSID;
//    static Char8 cvsid_inl[] = OSGDXFENTITYBASE_INLINE_CVSID;
}
