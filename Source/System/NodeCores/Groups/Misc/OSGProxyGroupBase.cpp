...
FieldDescription *ProxyGroupBase::_desc[] = 
{
    new FieldDescription(SFBool::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFEnabled)),
    new FieldDescription(SFString::getClassType(), 
                     "url", 
                     UrlFieldId, UrlFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFUrl)),
    new FieldDescription(SFNodePtr::getClassType(), 
                     "root", 
                     RootFieldId, RootFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFRoot)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "state", 
                     StateFieldId, StateFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFState)),
    new FieldDescription(SFBool::getClassType(), 
                     "concurrentLoad", 
                     ConcurrentLoadFieldId, ConcurrentLoadFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFConcurrentLoad)),
    new FieldDescription(SFDynamicVolume::getClassType(), 
                     "volume", 
                     VolumeFieldId, VolumeFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFVolume)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "indices", 
                     IndicesFieldId, IndicesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFIndices)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "triangles", 
                     TrianglesFieldId, TrianglesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFTriangles)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "positions", 
                     PositionsFieldId, PositionsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFPositions)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "geometries", 
                     GeometriesFieldId, GeometriesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFGeometries)),
    new FieldDescription(SFString::getClassType(), 
                     "absoluteUrl", 
                     AbsoluteUrlFieldId, AbsoluteUrlFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editSFAbsoluteUrl)),
    new FieldDescription(MFUInt8::getClassType(), 
                     "inline", 
                     InlineFieldId, InlineFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&ProxyGroupBase::editMFInline))
};
