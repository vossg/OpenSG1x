...
#ifndef _OSGFOGBASE_H_
#define _OSGFOGBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief Fog Base Class.

class OSG_SYSTEMLIB_DLLMAPPING FogBase : public Group
{
  private:
  ...
  public:
    ...
    enum
    {
        OnFieldId      = Inherited::NextFieldId,
        ModeFieldId    = OnFieldId      + 1,
    ...
    static  FogPtr      create          (void); 
    static  FogPtr      createEmpty     (void); 
  ...
  protected:
    ...
    void executeSyncImpl(      FogBase *pOther,
                         const BitVector         &whichField);
  ...
  private:
    ...
    void operator =(const FogBase &source);
};
...
typedef FogBase *FogBaseP;

typedef osgIF<FogBase::isNodeCore,
              CoredNodePtr<Fog>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet FogNodePtr;

typedef RefPtr<FogPtr> FogRefPtr;

OSG_END_NAMESPACE

#define OSGFOGBASE_HEADER_CVSID "@(#)$Id: OSGFogBase.h,v 1.1 2009/11/13 15:44:26 yjung Exp $"

#endif /* _OSGFOGBASE_H_ */
