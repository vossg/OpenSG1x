...
typedef osgIF<PointLightBase::isNodeCore,
              CoredNodePtr<PointLight>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet PointLightNodePtr;

typedef RefPtr<PointLightPtr> PointLightRefPtr;

OSG_END_NAMESPACE

#define OSGPOINTLIGHTBASE_HEADER_CVSID "@(#)$Id: FCBaseTemplate_h.h,v 1.38 2005/07/08 06:37:35 vossg Exp $"
