...
FieldDescription *DVRVolumeBase::_desc[] = 
{
    new FieldDescription(SFDVRAppearancePtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFAppearance)),
    new FieldDescription(SFDVRGeometryPtr::getClassType(), 
                     "geometry", 
                     GeometryFieldId, GeometryFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFGeometry)),
    new FieldDescription(SFDVRShaderPtr::getClassType(), 
                     "shader", 
                     ShaderFieldId, ShaderFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFShader)),
    new FieldDescription(SFString::getClassType(), 
                     "fileName", 
                     FileNameFieldId, FileNameFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFFileName)),
    new FieldDescription(SFReal32::getClassType(), 
                     "sampling", 
                     SamplingFieldId, SamplingFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFSampling)),
    new FieldDescription(SFReal32::getClassType(), 
                     "samplingInteractive", 
                     SamplingInteractiveFieldId, SamplingInteractiveFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFSamplingInteractive)),
    new FieldDescription(SFReal32::getClassType(), 
                     "baseAlpha", 
                     BaseAlphaFieldId, BaseAlphaFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFBaseAlpha)),
    new FieldDescription(SFBool::getClassType(), 
                     "doTextures", 
                     DoTexturesFieldId, DoTexturesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFDoTextures)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "brickOverlap", 
                     BrickOverlapFieldId, BrickOverlapFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFBrickOverlap)),
    new FieldDescription(SFQBit::getClassType(), 
                     "textures2D", 
                     Textures2DFieldId, Textures2DFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFTextures2D)),
    new FieldDescription(SFUInt16::getClassType(), 
                     "brickStaticMemoryMB", 
                     BrickStaticMemoryMBFieldId, BrickStaticMemoryMBFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFBrickStaticMemoryMB)),
    new FieldDescription(SFMaterialPtr::getClassType(), 
                     "renderMaterial", 
                     RenderMaterialFieldId, RenderMaterialFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFRenderMaterial)),
    new FieldDescription(SFUInt16::getClassType(), 
                     "brickingMode", 
                     BrickingModeFieldId, BrickingModeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFBrickingMode)),
    new FieldDescription(SFVec3f::getClassType(), 
                     "brickStaticSubdivision", 
                     BrickStaticSubdivisionFieldId, BrickStaticSubdivisionFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFBrickStaticSubdivision)),
    new FieldDescription(SFVec3f::getClassType(), 
                     "brickMaxSize", 
                     BrickMaxSizeFieldId, BrickMaxSizeFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFBrickMaxSize)),
    new FieldDescription(SFBool::getClassType(), 
                     "showBricks", 
                     ShowBricksFieldId, ShowBricksFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFShowBricks)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "drawStyle", 
                     DrawStyleFieldId, DrawStyleFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFDrawStyle)),
    new FieldDescription(MFString::getClassType(), 
                     "drawStyleNames", 
                     DrawStyleNamesFieldId, DrawStyleNamesFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editMFDrawStyleNames)),
    new FieldDescription(SFChunkMaterialPtr::getClassType(), 
                     "textureStorage", 
                     TextureStorageFieldId, TextureStorageFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRVolumeBase::editSFTextureStorage))
};
