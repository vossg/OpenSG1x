...
FieldDescription *DVRClipObjectsBase::_desc[] = 
{
    new FieldDescription(MFDVRClipGeometryPtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRClipObjectsBase::editMFClipObjects)),
    new FieldDescription(SFInt32::getClassType(), 
                     "clipMode", 
                     ClipModeFieldId, ClipModeFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&DVRClipObjectsBase::editSFClipMode)),
    new FieldDescription(SFBool::getClassType(), 
                     "doContours", 
                     DoContoursFieldId, DoContoursFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&DVRClipObjectsBase::editSFDoContours))
};
