...
FieldDescription *SurfaceBase::_desc[] = 
{
    new FieldDescription(SFUInt32::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFDimU)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "dimV", 
                     DimVFieldId, DimVFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFDimV)),
    new FieldDescription(MFReal32::getClassType(), 
                     "knotsU", 
                     KnotsUFieldId, KnotsUFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFKnotsU)),
    new FieldDescription(MFReal32::getClassType(), 
                     "knotsV", 
                     KnotsVFieldId, KnotsVFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFKnotsV)),
    new FieldDescription(SFGeoPositionsPtr::getClassType(), 
                     "controlPoints", 
                     ControlPointsFieldId, ControlPointsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFControlPoints)),
    new FieldDescription(SFReal32::getClassType(), 
                     "error", 
                     ErrorFieldId, ErrorFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFError)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "numCurves", 
                     NumCurvesFieldId, NumCurvesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFNumCurves)),
    new FieldDescription(MFUInt32::getClassType(), 
                     "knotLengths", 
                     KnotLengthsFieldId, KnotLengthsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFKnotLengths)),
    new FieldDescription(MFUInt32::getClassType(), 
                     "dimensions", 
                     DimensionsFieldId, DimensionsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFDimensions)),
    new FieldDescription(MFPnt3f::getClassType(), 
                     "curveControlPoints", 
                     CurveControlPointsFieldId, CurveControlPointsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFCurveControlPoints)),
    new FieldDescription(MFReal32::getClassType(), 
                     "knots", 
                     KnotsFieldId, KnotsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFKnots)),
    new FieldDescription(MFUInt32::getClassType(), 
                     "curvesPerLoop", 
                     CurvesPerLoopFieldId, CurvesPerLoopFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editMFCurvesPerLoop)),
    new FieldDescription(SFBool::getClassType(), 
                     "isDelaunay", 
                     IsDelaunayFieldId, IsDelaunayFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFIsDelaunay)),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFTextureControlPoints)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "dirtyMask", 
                     DirtyMaskFieldId, DirtyMaskFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFDirtyMask)),
    new FieldDescription(SFInt32::getClassType(), 
                     "SurfaceGLId", 
                     SurfaceGLIdFieldId, SurfaceGLIdFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::editSFSurfaceGLId))
};
...
FieldContainerType SurfaceBase::_type(
    ...
    "Geometry",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&SurfaceBase::createEmpty),
    Surface::initMethod,
    _desc,
    sizeof(_desc));
...
{
    this->executeSyncImpl(static_cast<SurfaceBase *>(&other),
                          whichField);
}
#else
void SurfaceBase::executeSync(      FieldContainer &other,
