...
FieldDescription *SurfaceBase::_desc[] = 
{
    new FieldDescription(SFUInt32::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFDimU)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "dimV", 
                     DimVFieldId, DimVFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFDimV)),
    new FieldDescription(MFReal32::getClassType(), 
                     "knotsU", 
                     KnotsUFieldId, KnotsUFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFKnotsU)),
    new FieldDescription(MFReal32::getClassType(), 
                     "knotsV", 
                     KnotsVFieldId, KnotsVFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFKnotsV)),
    new FieldDescription(SFGeoPositionsPtr::getClassType(), 
                     "controlPoints", 
                     ControlPointsFieldId, ControlPointsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFControlPoints)),
    new FieldDescription(SFReal32::getClassType(), 
                     "error", 
                     ErrorFieldId, ErrorFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFError)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "numCurves", 
                     NumCurvesFieldId, NumCurvesFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFNumCurves)),
    new FieldDescription(MFUInt32::getClassType(), 
                     "knotLengths", 
                     KnotLengthsFieldId, KnotLengthsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFKnotLengths)),
    new FieldDescription(MFUInt32::getClassType(), 
                     "dimensions", 
                     DimensionsFieldId, DimensionsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFDimensions)),
    new FieldDescription(MFPnt3f::getClassType(), 
                     "curveControlPoints", 
                     CurveControlPointsFieldId, CurveControlPointsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFCurveControlPoints)),
    new FieldDescription(MFReal32::getClassType(), 
                     "knots", 
                     KnotsFieldId, KnotsFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFKnots)),
    new FieldDescription(MFUInt32::getClassType(), 
                     "curvesPerLoop", 
                     CurvesPerLoopFieldId, CurvesPerLoopFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getMFCurvesPerLoop)),
    new FieldDescription(SFBool::getClassType(), 
                     "isDelaunay", 
                     IsDelaunayFieldId, IsDelaunayFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFIsDelaunay)),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFTextureControlPoints)),
    new FieldDescription(SFUInt32::getClassType(), 
                     "dirtyMask", 
                     DirtyMaskFieldId, DirtyMaskFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFDirtyMask)),
    new FieldDescription(SFInt32::getClassType(), 
                     "SurfaceGLId", 
                     SurfaceGLIdFieldId, SurfaceGLIdFieldMask,
                     true,
                     reinterpret_cast<FieldAccessMethod>(&SurfaceBase::getSFSurfaceGLId))
};
