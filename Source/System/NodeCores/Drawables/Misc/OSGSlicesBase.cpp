...
FieldDescription *SlicesBase::_desc[] = 
{
    new FieldDescription(SFVec3f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SlicesBase::editSFSize)),
    new FieldDescription(SFReal32::getClassType(), 
                     "sliceDistance", 
                     SliceDistanceFieldId, SliceDistanceFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&SlicesBase::editSFSliceDistance))
};
...
FieldContainerType SlicesBase::_type(
    ...
    "MaterialDrawable",
    NULL,
    reinterpret_cast<PrototypeCreateF>(&SlicesBase::createEmpty),
    Slices::initMethod,
    _desc,
    sizeof(_desc));
...
{
    this->executeSyncImpl(static_cast<SlicesBase *>(&other),
                          whichField);
}
#else
void SlicesBase::executeSync(      FieldContainer &other,
