...
FieldDescription *FresnelMaterialBase::_desc[] = 
{
    new FieldDescription(SFColor3f::getClassType(), 
                     ...
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFAmbient)),
    new FieldDescription(SFColor3f::getClassType(), 
                     "diffuse", 
                     DiffuseFieldId, DiffuseFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFDiffuse)),
    new FieldDescription(SFColor3f::getClassType(), 
                     "specular", 
                     SpecularFieldId, SpecularFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFSpecular)),
    new FieldDescription(SFReal32::getClassType(), 
                     "shininess", 
                     ShininessFieldId, ShininessFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFShininess)),
    new FieldDescription(SFColor3f::getClassType(), 
                     "emission", 
                     EmissionFieldId, EmissionFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFEmission)),
    new FieldDescription(SFReal32::getClassType(), 
                     "transparency", 
                     TransparencyFieldId, TransparencyFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFTransparency)),
    new FieldDescription(SFBool::getClassType(), 
                     "lit", 
                     LitFieldId, LitFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFLit)),
    new FieldDescription(SFGLenum::getClassType(), 
                     "colorMaterial", 
                     ColorMaterialFieldId, ColorMaterialFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFColorMaterial)),
    new FieldDescription(SFReal32::getClassType(), 
                     "index", 
                     IndexFieldId, IndexFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFIndex)),
    new FieldDescription(SFReal32::getClassType(), 
                     "scale", 
                     ScaleFieldId, ScaleFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFScale)),
    new FieldDescription(SFReal32::getClassType(), 
                     "bias", 
                     BiasFieldId, BiasFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFBias)),
    new FieldDescription(SFImagePtr::getClassType(), 
                     "image", 
                     ImageFieldId, ImageFieldMask,
                     false,
                     reinterpret_cast<FieldAccessMethod>(&FresnelMaterialBase::editSFImage))
};
