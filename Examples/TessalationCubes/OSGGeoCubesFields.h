    ...
    public FieldTraitsRecurseMapper<GeoCubesPtr, true>
{
    ...
    static const char *getSName(void) { return "SFGeoCubesPtr"; }
    static const char *getMName(void) { return "MFGeoCubesPtr"; }
};
...
#define OSGGEOCUBESFIELDS_HEADER_CVSID "@(#)$Id: FCFieldsTemplate_h.h,v 1.25 2005/04/04 14:51:48 dirk Exp $"
