...
// Source file for new Field type, library version
...
// not for using it.
#define OSG_COMPILETRIPLEINTLIBINST
...
// The parameters are the name of the type and the name of the 
// parent type (if any)
DataType FieldDataTraits<TripleIntLib>::_type("TripleIntLib", "");
...
namespace
{
    ...
    static Char8 cvsid_hpp[] = OSGNEWFIELDTYPELIB_HEADER_CVSID;
}
