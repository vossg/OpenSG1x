...
DataType FieldDataTraits<SimpleTexturedMaterialPtr>::_type("SimpleTexturedMaterialPtr", "SimpleMaterialPtr", true);
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGSimpleTexturedMaterialBase.cpp,v 1.6 2001/11/09 08:17:10 vossg Exp $";
...
{ 
    return sizeof(SimpleTexturedMaterialBase); 
}
