...
void LogoForeground::initMethod (void)
{
}
...
LogoForeground::LogoForeground(void) :
    Inherited()
{
}
...
LogoForeground::LogoForeground(const LogoForeground &source) :
    Inherited(source)
{
}
...
void LogoForeground::changed(BitVector, ChangeMode)
{
}
...
void LogoForeground::dump(      UInt32     uiIndent, 
                         const BitVector &bvFlags) const
{
	SLOG << "Dump LogoForeground NI" << endl;
}


/** \brief draw the logos 
 */
    
void LogoForeground::draw(DrawActionBase *, ViewportP)
{
