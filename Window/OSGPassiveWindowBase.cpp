...
DataType FieldDataTraits<PassiveWindowPtr>::_type("PassiveWindowPtr", "WindowPtr", true);
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGPassiveWindowBase.cpp,v 1.1 2002/01/28 21:24:11 dirk Exp $";
...
{ 
    return sizeof(PassiveWindowBase); 
}
