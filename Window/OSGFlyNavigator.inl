...
inline Matrix &FlyNavigator::getMatrix()
{
...
inline void FlyNavigator::setFrom(Pnt3f new_eye)
{
    _rEye=new_eye;
}
...
inline void FlyNavigator::setAt(Pnt3f new_center)
{
    _rCenter=new_center;
}
...
inline void FlyNavigator::setUp(Vec3f new_up)
{
    _vUp=new_up;
}
...
inline void FlyNavigator::rotate(Real32 deltaX, Real32 deltaY)
{    
...
inline void FlyNavigator::forward(Real32 step)
{
    Vec3f lv;
    lv=_rEye-_rCenter;
    lv.normalize();                                  
...
inline void FlyNavigator::right(Real32 step)
{
    Vec3f sv;
    sv=_rEye-_rCenter;
    sv.crossThis(_vUp);
