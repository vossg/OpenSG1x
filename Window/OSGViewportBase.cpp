...
DataType FieldDataTraits<ViewportPtr>::_type("ViewportPtr", "AttachmentContainerPtr", true);
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGViewportBase.cpp,v 1.24 2001/11/09 08:17:07 vossg Exp $";
