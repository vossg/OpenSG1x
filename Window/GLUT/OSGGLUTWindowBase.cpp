...
DataType FieldDataTraits<GLUTWindowPtr>::_type("GLUTWindowPtr", "WindowPtr", true);
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGGLUTWindowBase.cpp,v 1.1 2002/02/05 20:39:33 dirk Exp $";
