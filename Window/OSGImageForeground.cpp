...
char ImageForeground::cvsid[] = "@(#)$Id: OSGImageForeground.cpp,v 1.2 2001/10/05 04:17:43 vossg Exp $";
...
void ImageForeground::changed(BitVector, ChangeMode)
{
}
...
void ImageForeground::dump(      UInt32     uiIndent, 
