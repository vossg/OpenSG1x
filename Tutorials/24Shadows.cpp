...
// with our new much improved ShadowViewport (tutorial 21 is based on
// our old ShadowMapViewport)
// Following algorithms are supported
// - standard shadow mapping
// - perspective shadow mapping
// - dither shadow mapping (soft shadows)
// - pcf shadow mapping (soft shadows)
// - pcss shadow mapping (soft shadows)
...
int main(int argc, char **argv)
{
    ...
    NodePtr                 tree1 = SceneFileHandler::the().read("Data/tree1.3ds");
