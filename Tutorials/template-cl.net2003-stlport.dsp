...
LINK32=link.exe%
# ADD BASE LINK32 %
# ADD LINK32 user32.lib kernel32.lib MSVCPRT.lib MSVCRT.lib winmm.lib wsock32.lib OSGBase.lib OSGSystem.lib OSGWindowGLUT.lib glut32.lib opengl32.lib tif32.lib libjpeg.lib stlport_vc7.lib -NODEFAULTLIB /LIBPATH:"..\lib" /LIBPATH:"..\lib\glut_3.7\lib" /LIBPATH:"../lib/jpg6b/lib" /LIBPATH:"../lib/tiff-3.5.4/lib" %
%
...
LINK32=link.exe%
# ADD BASE LINK32 %
# ADD LINK32 user32.lib kernel32.lib MSVCPRTD.lib MSVCRTD.lib winmm.lib wsock32.lib OSGBaseD.lib OSGSystemD.lib OSGWindowGLUTD.lib glut32.lib opengl32.lib tif32.lib libjpeg.lib stlport_vc7.lib -NODEFAULTLIB -Debug /LIBPATH:"..\lib" /LIBPATH:"..\lib\glut_3.7\lib" /LIBPATH:"../lib/jpg6b/lib" /LIBPATH:"../lib/tiff-3.5.4/lib" %
# SUBTRACT LINK32 %
%
!ENDIF %
%
