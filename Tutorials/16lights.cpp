...
void display( void )
{
    ...
    for(UInt16 i = 0; i < nlights; ++i)
    {
        ...
        beginEditCP(lightBeacons[i], Transform::MatrixFieldMask);
        {
            lightBeacons[i]->setMatrix(m);
        }   
        endEditCP  (lightBeacons[i], Transform::MatrixFieldMask);
    }
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    {        
        ...
        switch((i % 3) + 0)
        {
            ...
            */
            case 0:
            {
                ...
                beginEditCP(l, PointLight::PositionFieldMask             |
                ...
                endEditCP  (l, PointLight::PositionFieldMask             |
                               PointLight::ConstantAttenuationFieldMask  |
                               PointLight::LinearAttenuationFieldMask    |
                               PointLight::QuadraticAttenuationFieldMask );
                ...
                GeometryPtr geo = GeometryPtr::dcast(geo_node->getCore());
            ...
            */
            case 1:
            {
                ...
                beginEditCP(l, DirectionalLight::DirectionFieldMask);
                {
                    l->setDirection(0, 0, 1);
                }
                endEditCP  (l, DirectionalLight::DirectionFieldMask);
            ...
            */
            case 2:
            {
                ...
                beginEditCP(l, SpotLight::PositionFieldMask              |
                               SpotLight::DirectionFieldMask             |
                               SpotLight::SpotExponentFieldMask          |
                               SpotLight::SpotCutOffFieldMask            |
                               SpotLight::ConstantAttenuationFieldMask   |
                               SpotLight::LinearAttenuationFieldMask     |
                               SpotLight::QuadraticAttenuationFieldMask  );
                {
                    l->setPosition             (Pnt3f(0,  0, 0));
                    l->setDirection            (Vec3f(0, -1, 0));
                    l->setSpotExponent         (2);
                    l->setSpotCutOff           (deg2rad(45));
                    l->setConstantAttenuation  (1);
                    l->setLinearAttenuation    (0);
                    l->setQuadraticAttenuation (3);
                }
                endEditCP  (l, SpotLight::PositionFieldMask              |
                               SpotLight::DirectionFieldMask             |
                               SpotLight::SpotExponentFieldMask          |
                               SpotLight::SpotCutOffFieldMask            |
                               SpotLight::ConstantAttenuationFieldMask   |
        ...
        beginEditCP(beacon, Node::CoreFieldMask | Node::ChildrenFieldMask);
        {
            beacon->setCore(beacon_core);
            beacon->addChild(geo_node);
        }
        endEditCP  (beacon, Node::CoreFieldMask | Node::ChildrenFieldMask);
        ...
        beginEditCP(light, Node::CoreFieldMask | Node::ChildrenFieldMask);
        {
            light->setCore(light_core);
            light->addChild(lastnode);
        }
        endEditCP  (light, Node::CoreFieldMask | Node::ChildrenFieldMask);
