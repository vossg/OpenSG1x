...
#pragma instantiate SField<SimpleStatisticsForegroundPtr>::_fieldType
#pragma instantiate MField<SimpleStatisticsForegroundPtr>::_fieldType

#else

OSG_DLLEXPORT_DEF1(SField, SimpleStatisticsForegroundPtr, OSG_SYSTEMLIB_DLLTMPLMAPPING)
OSG_DLLEXPORT_DEF1(MField, SimpleStatisticsForegroundPtr, OSG_SYSTEMLIB_DLLTMPLMAPPING)
...
namespace
{
    static Char8 cvsid_cpp       [] = "@(#)$Id: OSGSimpleStatisticsForegroundBase.cpp,v 1.1 2002/03/19 17:46:17 dirk Exp $";
...
{ 
    return sizeof(SimpleStatisticsForegroundBase); 
}
