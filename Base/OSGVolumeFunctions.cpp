...
OSG_BASE_DLLMAPPING Bool intersect(const BoxVolume &box1, const BoxVolume &box2)
{
    ...
    if(box1.isEmpty() || box2.isEmpty())
        retCode = false;
    else if(box1.isInfinite() || box2.isInfinite())
        retCode = true;
    else
    {
        retCode =
                                   ...
                                   const SphereVolume &sphere)
{
    ...
    if(box.isEmpty() || sphere.isEmpty())
        retCode = false;
    else if(box.isInfinite() || sphere.isInfinite())
        retCode = true;
    else
    {
                                   ...
                                   const CylinderVolume &cylinder)
{
    ...
    if(box.isEmpty() || cylinder.isEmpty())
        retCode = false;
    else if(box.isInfinite() || cylinder.isInfinite())
        retCode = true;
    else
    {
                                   ...
                                   const CylinderVolume &cylinder2)
{
    ...
    if(cylinder1.isEmpty() || cylinder2.isEmpty())
        retCode = false;
    else if(cylinder1.isInfinite() || cylinder2.isInfinite())
        retCode = true;
    else
...
// # Box #############################################################
OSG_BASE_DLLMAPPING void extend(BoxVolume &srcVol, const BoxVolume &vol)
{
...
/* */
OSG_BASE_DLLMAPPING void extend(BoxVolume &srcVol, const SphereVolume &vol)
{
    Pnt3f   min, max;
...
/* */
OSG_BASE_DLLMAPPING void extend(BoxVolume &srcVol, const CylinderVolume &vol)
{
    Pnt3f   min, max;
...
// # Sphere ###########################################################
OSG_BASE_DLLMAPPING void extend(SphereVolume &srcVol, const BoxVolume &vol)
{
...
/* */
OSG_BASE_DLLMAPPING void extend(SphereVolume &srcVol, const SphereVolume &vol)
{
    ...
    min2 = Pnt3f(osgMin(min.x(), min1.x()), osgMin(min.y(), min1.y()),
                 osgMin(min.z(), min1.z()));
...
/* */
OSG_BASE_DLLMAPPING void extend(SphereVolume &srcVol, const CylinderVolume &vol)
{
    Pnt3f   min, max, min1, max1, min2, max2, c;
    float   r;
...
/* */
OSG_BASE_DLLMAPPING void extend(SphereVolume &srcVol, const Volume &vol)
{
    const Volume        *v = &vol;
    const SphereVolume  *sphere;
    const DynamicVolume *dynamic = dynamic_cast<const DynamicVolume *>(v);
...
// # Cylinder ########################################################
OSG_BASE_DLLMAPPING void extend(CylinderVolume &srcVol, const BoxVolume &vol)
{
...
/* */
OSG_BASE_DLLMAPPING void extend(CylinderVolume &srcVol, const SphereVolume &vol)
{
    Pnt3f   min, max, min1, max1, min2, max2, apos;
    Vec2f   p;
    Vec3f   adir;
    ...
    if(srcVol.isEmpty())
    {
        ...
        {
            r = vol.getRadius();
            apos = Pnt3f(vol.getCenter().x() - r, vol.getCenter().y() - r,
                         vol.getCenter().z() - r);
...
/* */
OSG_BASE_DLLMAPPING void extend(CylinderVolume &srcVol, const CylinderVolume &vol)
{
    Pnt3f   min, max, min1, max1, min2, max2, apos;
    Vec2f   p;
    Vec3f   adir;
