...
LINK32=xilink6.exe
# ADD BASE LINK32           
# ADD LINK32 user32.lib kernel32.lib MSVCPRTD.lib MSVCRTD.lib libmmdd.lib winmm.lib wsock32.lib  opengl32.lib glu32.lib gdi32.lib glut32.lib -NODEFAULTLIB -dll -map -Debug -out:..\lib\dbg\OSGWindowGLUTD.dll
...
# Begin Group "SourceWindowSystemGLUT Install "
# PROP Default_Filter ""
...
"../include/OpenSG/OSGGLUTWindow.h": $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	sed.exe -e "s/include[ ]*<OSG/include <OpenSG\/OSG/g" -e "s/include[ ]*\"OSG/include \"OpenSG\/OSG/g" ../../../Source/WindowSystem/GLUT/OSGGLUTWindow.h > ../include/OpenSG/OSGGLUTWindow.h
...
"../include/OpenSG/OSGGLUTWindowBase.h": $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	sed.exe -e "s/include[ ]*<OSG/include <OpenSG\/OSG/g" -e "s/include[ ]*\"OSG/include \"OpenSG\/OSG/g" ../../../Source/WindowSystem/GLUT/OSGGLUTWindowBase.h > ../include/OpenSG/OSGGLUTWindowBase.h
...
"../include/OpenSG/OSGGLUTWindowFields.h": $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	sed.exe -e "s/include[ ]*<OSG/include <OpenSG\/OSG/g" -e "s/include[ ]*\"OSG/include \"OpenSG\/OSG/g" ../../../Source/WindowSystem/GLUT/OSGGLUTWindowFields.h > ../include/OpenSG/OSGGLUTWindowFields.h
...
"../include/OpenSG/OSGWindowGLUTDef.h": $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	sed.exe -e "s/include[ ]*<OSG/include <OpenSG\/OSG/g" -e "s/include[ ]*\"OSG/include \"OpenSG\/OSG/g" ../../../Source/WindowSystem/GLUT/OSGWindowGLUTDef.h > ../include/OpenSG/OSGWindowGLUTDef.h
...
"../include/OpenSG/OSGGLUTWindow.inl": $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	sed.exe -e "s/include[ ]*<OSG/include <OpenSG\/OSG/g" -e "s/include[ ]*\"OSG/include \"OpenSG\/OSG/g" ../../../Source/WindowSystem/GLUT/OSGGLUTWindow.inl > ../include/OpenSG/OSGGLUTWindow.inl
...
"../include/OpenSG/OSGGLUTWindowBase.inl": $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	sed.exe -e "s/include[ ]*<OSG/include <OpenSG\/OSG/g" -e "s/include[ ]*\"OSG/include \"OpenSG\/OSG/g" ../../../Source/WindowSystem/GLUT/OSGGLUTWindowBase.inl > ../include/OpenSG/OSGGLUTWindowBase.inl
