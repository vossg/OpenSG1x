...
"    (static_cast<OSG::BitVector>(1) << @!Classname!@Base::DecorateeFieldId);",
"@@else",
"@@if hasFields", 
"@@BeginFieldLoop@@",
"const OSG::BitVector  @!Classname!@Base::@!Fieldname!@FieldMask = ",
"    (static_cast<OSG::BitVector>(1) << @!Classname!@Base::@!Fieldname!@FieldId);",
"",
"@@EndFieldLoop@@",
"@@endif",
"const OSG::BitVector @!Classname!@Base::MTInfluenceMask = ",
"    (Inherited::MTInfluenceMask) | ",
"    (@!LocalMTInfluenceMask!@ << Inherited::NextFieldId); ",
//"",
...
"namespace",
"{",
"    static Char8 cvsid_cpp       [] = \"@(#)$Id: FCBaseTemplate_cpp.h,v 1.39 2003/03/14 02:38:52 dirk Exp $\";",
