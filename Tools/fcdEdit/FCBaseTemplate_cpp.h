...
"",
"@@if SFPointerfield",
"OSG_DLLEXPORT_DEF1(SField, @!Classname!@Ptr, OSG_@!LIBNAME!@_DLLTMPLMAPPING)",
"@@endif",
"@@if MFPointerfield",
"OSG_DLLEXPORT_DEF1(MField, @!Classname!@Ptr, OSG_@!LIBNAME!@_DLLTMPLMAPPING)",
"@@endif",
"",
"#endif",
"",
...
"@@endif", 
"",
"char @!Classname!@Base::cvsid[] = \"@(#)$Id: FCBaseTemplate_cpp.h,v 1.6 2001/05/30 16:25:24 vossg Exp $\";",
"",
"@@if hasFields", 
