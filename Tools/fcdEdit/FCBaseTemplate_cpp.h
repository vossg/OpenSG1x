...
"",
"@@if SFPointerfield",
"OSG_DLLEXPORT_DEF1(SField, @!Classname!@Ptr, OSG_MISC_DLLTMPLMAPPING)",
"@@endif",
"@@if MFPointerfield",
"OSG_DLLEXPORT_DEF1(MField, @!Classname!@Ptr, OSG_MISC_DLLTMPLMAPPING)",
"@@endif",
"",
"#endif",
"",
...
"@@endif", 
"",
"char @!Classname!@Base::cvsid[] = \"@(#)$Id: FCBaseTemplate_cpp.h,v 1.2 2001/04/03 13:06:39 dirk Exp $\";",
"",
"@@if hasFields", 
