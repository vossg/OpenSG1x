...
"@@BeginFieldLoop@@",
"@@if isPublic", 
"    inline       @!CARDINALITY!@@!CapsFieldtype:17!@ *get@!CARDINALITY!@@!Fieldname:15!@(void);",
"@@endif", 
"@@EndFieldLoop@@",
"",
"@@BeginSFFieldLoop@@",
...
"    inline       @!CARDINALITY!@@!CapsFieldtype:17!@ &get@!Fieldname:15!@(void);",
"    inline const @!CARDINALITY!@@!CapsFieldtype:17!@ &get@!Fieldname:15!@(void) const;",
"@@endif", 
"@@EndMFFieldLoop@@",
"",
"    /*! \\}                                                                 */",
...
"OSG_END_NAMESPACE",
"",
"#define OSG@!CLASSNAME!@BASE_HEADER_CVSID \"@(#)$Id: FCBaseTemplate_h.h,v 1.20 2001/11/01 05:55:09 vossg Exp $\"",
"", 
